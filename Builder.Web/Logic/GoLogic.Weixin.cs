    ...
    public abstract partial class GoLogic
    {
        ...
        public class WeixinHelper
        {
            ...
            public string Mch_ID
            {
                get
                {
                    return ComFunc.nvl(_logic.CallContext_Parameter.ExtentionObj.weixin.mch_id);
                }
            }
            /// <summary>
            /// 微信商户支付秘钥
            ...
            public string Mch_Key
            {
                get
                {
                    return ComFunc.nvl(_logic.CallContext_Parameter.ExtentionObj.weixin.mch_key);
                }
            }
            /// <summary>
            ...
            public string Nonce_str
            {
                get
                {
                    return ComFunc.nvl(_logic.CallContext_Parameter.ExtentionObj.weixin.nonce);
                }
            }
            /// <summary>
            /// 请求的FromUserName
            ...
            public string Pay_AuthDirectory
            {
                get
                {
                    return ComFunc.nvl(_logic.CallContext_Parameter.ExtentionObj.weixin.weixin_authpaydir);
                }
            }
            /// <summary>
            ...
            public string Access_Token
            {
                get
                {
                    ...
                    {
                        GlobalCommon.Logger.WriteLog(LoggerLevel.INFO, "***** GoLogic.Weixin.cs Access_Token start *********************************************************************************************");
                        ...
                        if (token != "")
                        {
                            _logic.CacheHelper.SetCache(AppID + "_weixin_access_token", token, DateTime.Now.AddSeconds(IntStd.ParseStd(expireseconds).Value));
                        }
                        GlobalCommon.Logger.WriteLog(LoggerLevel.INFO, "***** GoLogic.Weixin.cs Access_Token End *********************************************************************************************");
            ...
            public string Jsapi_ticket
            {
                get
                {
                    ...
                    {
                        var result = _logic.OuterInterface.CallWeixinServer(string.Format("https://api.weixin.qq.com/cgi-bin/ticket/getticket?access_token={0}&type=jsapi", Access_Token));
                        dynamic dobj = (FrameDLRObject)result;
            ...
            public string GenPayNotify_url(string url)
            {
                ...
                var token = ComFunc.nvl(_logic.CallContext_Parameter.ExtentionObj.weixin.token);
...
"openCard" });
            ...
            /// <returns></returns>
            public FrameDLRObject UnifiedOrder4JSAPI(string notify_url, string openid, string orderno, double amount, string body, string attachdata)
            {
                ...
                var result = _logic.OuterInterface.CallWeixinServer(string.Format("https://api.mch.weixin.qq.com/pay/unifiedorder"), ResponseHeader_ContentType.xml, p);
...
prepay_id:''
            ...
            public FrameDLRObject QueryUnifiedOrder(string transaction_id, string out_trade_no)
            {
                ...
                p.SetValue("sign", WXBizMsgCrypt.GenMD5SignString(p, Mch_Key));
                var result = _logic.OuterInterface.CallWeixinServer(string.Format("https://api.mch.weixin.qq.com/pay/orderquery"), ResponseHeader_ContentType.xml, p);
                var rtn = FrameDLRObject.CreateInstance(@"{
issuccess:false,
msg:'',
}");
            ...
            public FrameDLRObject RefundOrder(string transaction_id, string out_trade_no, string out_refund_no,decimal amount,string fundtype="CNY")
            {
                ...
                var result = _logic.OuterInterface.CallWeixinServer(string.Format("https://api.mch.weixin.qq.com/secapi/pay/refund"), ResponseHeader_ContentType.xml, p, true);
                var rtn = FrameDLRObject.CreateInstance(@"{
issuccess:false,
msg:'',
}");
                ...
                string send_name)
            {
                ...
                var result = _logic.OuterInterface.CallWeixinServer(string.Format("https://api.mch.weixin.qq.com/mmpaymkttransfers/sendredpack"), ResponseHeader_ContentType.xml, p, true);
...
msg:'',
                ...
                string send_name, string callbackLA, FrameDLRObject cachedata)
            {
                ...
                _logic.OuterInterface.CallWeixinServerAsync(string.Format("https://api.mch.weixin.qq.com/mmpaymkttransfers/sendredpack"), ResponseHeader_ContentType.xml, p, true, callbackLA, cachedata);
            }
            /// <summary>
            /// 获取异步回调结果集
            /// </summary>
            public dynamic CallBackResult
            {
                get
                {
                    return _logic.CallContext_Parameter.GetValue(DomainKey.POST_DATA, "weixincallbackresult");
                }
            }
           /// <summary>
           /// 获取红包异步回调结果集
...
msg:'',
                ...
                string send_name)
            {
                ...
                var result = _logic.OuterInterface.CallWeixinServer(string.Format("https://api.mch.weixin.qq.com/mmpaymkttransfers/sendgroupredpack"), ResponseHeader_ContentType.xml, p, true);
                var rtn = FrameDLRObject.CreateInstance(@"{
issuccess:false,
error_code:'',
msg:'',
            ...
            public dynamic Pay2Customer(string appid, string openid, string username, double amount, string desc, bool isneed_name_check)
            {
                ...
                var result = _logic.OuterInterface.CallWeixinServer(string.Format("https://api.mch.weixin.qq.com/mmpaymkttransfers/promotion/transfers"), ResponseHeader_ContentType.xml, p, true);
...
msg:'',
            ...
            public void Pay2CustomerAsync(string appid, string openid, string username, double amount, string desc, bool isneed_name_check, string callbackLA, FrameDLRObject cachedata)
            {
                ...
                _logic.OuterInterface.CallWeixinServerAsync(string.Format("https://api.mch.weixin.qq.com/mmpaymkttransfers/promotion/transfers"), ResponseHeader_ContentType.xml, p, true, callbackLA, cachedata);
            }
            /// <summary>
            /// 生成一个临时二维码
            /// </summary>
            ...
            public dynamic CreateTempQR(string accesstoken, string scene_id)
            {
                ...
                dynamic re = _logic.OuterInterface.CallWeixinServer(url, @"{
            expire_seconds: 0,
...
msg:'',
                ...
                var result = _logic.OuterInterface.CallWeixinServer(url, "multipart/form-data", p, false);
...
msg:'',
                ...
                dynamic result = _logic.OuterInterface.CallWeixinServer(url);
            ...
            public dynamic SendTemplateMsg(FrameDLRObject p)
            {
                ...
                var result = _logic.OuterInterface.CallWeixinServer(url, ResponseHeader_ContentType.json, p, false);
      ...
      media_id:'" + media_id + @"'
            ...
            public string Long2ShortUrl(string longurl,string accesstoken)
            {
                ...
                else
                {
                    ...
                    var result = _logic.OuterInterface.CallWeixinServer(url, "Post", ResponseHeader_ContentType.json, postdata, false);
            ...
            {
                var rtn = GenResponseObject();
                dynamic info =  _logic.OuterInterface.CallWeixinServer(string.Format("https://api.weixin.qq.com/cgi-bin/user/info?access_token={0}&openid={1}&lang=zh_CN", Access_Token, openid));

                rtn.nickname = ComFunc.nvl(info.nickname);
                rtn.sex = IntStd.IsInt(info.sex) ? IntStd.ParseStd(info.sex).Value : 0;
                rtn.headurl = ComFunc.nvl(info.headimgurl);
                return rtn;
            }
        }
    }
